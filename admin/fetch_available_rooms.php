...
if(isset($_POST['checkInDate']) && isset($_POST['checkOutDate']) && isset($_POST['roomTypeId'])) {
    ...
    WHERE room.room_id NOT IN (
        ...
        WHERE (check_in BETWEEN '$checkInDate' AND '$checkOutDate')
        OR (check_out BETWEEN '$checkInDate' AND '$checkOutDate')
