            ...
            <div class="main">
                ...
                <main class="content px-3 py-2">
                    ...
                    <div class="container-fluid  p-3 my-container">
                        <h1>Add about carousle</h1><br>
                        <form method="POST" action="add_about_carousle.php" enctype="multipart/form-data">
            ...
            if ($_FILES["image"]["size"] > 500000) {
                ...
                if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif") {
                    ...
                    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                        ...
                        $sql = "INSERT INTO about_heading_image (caption_heading, caption_text, image_path) VALUES ('$caption_heading', '$caption_text', '$image_path')";
