            ...
            <div class="main">
                ...
                <main class="content px-3 py-2">
                    ...
                    <div class="container-fluid text- p-3 my-container">
                        <div class="container">
                            <h1>Edit about carousle</h1>
                            <div class="mb-3">
                                <a href="add_about_carousle.php" class="btn btn-success">Add New Entry</a>
                            </div>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT id, image_path, caption_heading, caption_text FROM about_heading_image";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="POST" action="edit_about_carousle.php" style="display: inline;">
                                                        <a href="edit_about_carousle.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a>
                                                    </form>
