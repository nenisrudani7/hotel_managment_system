                    ...
                    <div class="container-fluid text-center p-3 my-container">
                        <div class="container-fluid text-center p-3 my-container">
                            <div class="row mx-2">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 mb-3">
                                    <div class="card text-white bg-secondary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="room_carousle.php" class="btn btn-light">Go to Carousel</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 mb-3">
                                    <div class="card text-white bg-secondary">
                                        <div class="card-header bg-dark">room manage</div>
                                        <div class="card-body">
                                            <h1 class="card-title">edit Here</h1>
                                            <a href="room_view.php" class="btn btn-light">Go to Room Type</a>
                                        </div>
                                    </div>
                                </div>
