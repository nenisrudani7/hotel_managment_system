...
<body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse text-white" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link text-white me-2 " href="hotel.html">HOME</a>
              </li>

              <li class="nav-item">
                <a class="nav-link text-white me-2 " href="room.html">ROOMS</i>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white me-2 " href="gallery.html">GALLERY</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white me-2" href="about.html">ABOUT</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white me-2" href="contact.html">CONTACT</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white me-2"><button type="button" class="btn btn-danger" data-bs-toggle="modal"
                  data-bs-target="#exampleModal">SIGN-IN</button></a>
              </li>
            </ul>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header bg-dark">
          <h5 class="modal-title text-white" id="exampleModalLabel">SIGNIN</h5>
  ...
  <br>
  <div class="row">
    <div class="col text-center text-white" style="text-decoration: underline;">
      <h1>ABOUT US</h1>
    </div>
  </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-5 text-dark  text-center">
          ...
          <p><a href="https://www.youtube.com/watch?v=4K6Sh1tsAW4&ab_channel=BogdanIorga"
              class="popup-vimeo text-up percase text-dark " previewlistener="true">Watch Video <i
    ...
    <div class="row">
      <div class="col-sm-8 text-dark mt-6" style="display:flex;  justify-content: center; text-align: center;">
        <form style="margin-top: 200px;">
          ...
          <p><a href="https://youtu.be/xqKcHz47E5A?si=cg-VdvEehXV5Q1pM" class="popup-vimeo text-uppercase text-dark "
  ...
  <div class="container g-2 p-3">
    <div class="row align-items-center">
      ...
      <div class="col-sm-8 md-8 text-dark text-center">
        ...
        <p><a href="https://youtu.be/NC9KlaxtfLg?si=St6kKWSPUS2u3IoJ" class="popup-vimeo text-uppercase text-dark "
            previewlistener="true">Watch Video <i class="fa-solid fa-arrow-right"></i> <span
              class="icon-arrow-right small"></span></a></p>
      </div>
    </div>
      ...
      <div class=" container-fluid p-4 pb-0">
        ...
        <section class="">
          ...
          <div class="row">
            ...
            <!-- Grid column -->
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3 text-white">
              <h6 class="text-uppercase mb-4 font-weight-bold">QUICK MENU</h6>
              <p>
                <a  href="hotel.html" class="text-white">Home</a>
              </p>
              <p>
                <a  href="room.html" class="text-white">Rooms</a>
              </p>
              <p>
                <a href="gallery.html" class="text-white">Gallary</a>
              </p>
              <p>
                <a   href="about.html" class="text-white">About</a>
              </p>
              <p>
                <a  href="contact.html" class="text-white">Contect</a>
              </p>
            </div>
