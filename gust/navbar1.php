...
<head>
  ...
  $(document).ready(function() {
    ...
    $.validator.addMethod("passwordregex", function(value, element) {
      // Updated password validation regex (at least 8 characters including one letter, one digit, and one special character)
    ...
    $("#signupForm").validate({
      ...
      messages: {
        ...
        password: {
          ...
          passwordregex: "Password must be at least 8 characters and include at least one letter, one digit, and one special character"
        },
        confirm_password: {
...
<body>
  ...
  <?php
        ...
        $insert_sql = "INSERT INTO register (`name`, `email`, `password`, `token`, `status`) VALUES ('$name', '$email', '$password', '$token', 'inactive')";
        ...
        if ($conn->query($insert_sql) === TRUE) {
          ...
          try {
            ...
            $mail->Body    = 'Congratulations! ' . $name . ' Your account has been created successfully. This email is for your account verification. <br> Kindly click on the link below to verify your account. You will be able to login into your account only after account verification. <br>
                    <a href="http://localhost/hotel_managment_system1/gust/verify_account.php?em=' . $email . '&token=' . $token . '">Click here to verify your account</a>';
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="loginForm" method="post" action="action_login.php">
            ...
            <!-- Login Button -->
            <button type="submit" class="btn btn-danger" name="lgn_btn">Login</button>
            <!-- Registration Link -->
            <p>Don't have an account? <a href="#" data-bs-toggle="modal" style="color:red;" data-bs-target="#exampleModal1">Register</a>
            </p>

            <p>Don't Remember!? <a href="forget.php"  style="color:red;" >Forget-Password</a></p>
          </form>
        </div>
      </div>
    </div>
