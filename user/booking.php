        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse text-white" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link text-white me-2 " href="room1.html">ROOMS</i>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white me-2 " href="gallery1.html">GALLARY</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link text-white me-2" href="booking.html" ><i class="fa-solid fa-book-bookmark"></i></a>
              </li>
            </ul>
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <a class="btn btn-primary btn-floating m-1" style="background-color: #ac2bac"
                  href="https://www.instagram.com/jay_sankaliya_?igsh=MTVwYWczbHpmMTVhMQ==" role="button"><i
